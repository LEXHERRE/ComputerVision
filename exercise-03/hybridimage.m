...
figure;
set(gcf,'Name','Fourier transforms of the images');

subplot(2,3,1); imagesc(log(abs(fftshift(fft2(man)))));
axis image; colormap gray;
title('Fourier transform of the original man image');

subplot(2,3,2); imagesc(log(abs(fftshift(fft2(man_lowpass)))));
axis image; colormap gray;
title('Fourier transform of the low-pass filtered man image');

subplot(2,3,3); imagesc(log(abs(fftshift(fft2(man_highpass)))));
axis image; colormap gray;
title('Fourier transform of the high-pass filtered man image');

subplot(2,3,4); imagesc(log(abs(fftshift(fft2(wolft)))));
axis image; colormap gray;
title('Fourier transform of the original wolf image');

subplot(2,3,5); imagesc(log(abs(fftshift(fft2(wolft_lowpass)))));
axis image; colormap gray;
title('Fourier transform of the low-pass filtered wolf image');

subplot(2,3,6); imagesc(log(abs(fftshift(fft2(wolft_highpass)))));
axis image; colormap gray;
title('Fourier transform of the high-pass filtered wolf image');
